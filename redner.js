document.getElementById("myBtn").addEventListener("click",redenerHinzufuegen);
  ...
  function redenerHinzufuegen() {
      ...
      list.innerHTML=`${input.value} <span id="std">00</span>:<span id="min">00</span>:<span id="sec">00</span> <button>Stop</button>`;
      ...
      stopRedener.addEventListener("click", function (){ resetButtons(); startTimer();
      });
